...
#search_name = input("\nEnter student's first or last name: ").strip().lower()

#if search_name in assignments:
	#print_coordinates(search_name, assignments[search_name])
#else:
	#print("No Matching student found. Try again")
